...
namespace _02_Operators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Lists are not equal because the are not stored in the same location in heep
            // Have to compare the contents not the lists themselves
            ...
            //example to understand would never code like this
