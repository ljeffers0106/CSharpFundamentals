...
namespace _01_ReverenceTypes
{
    class Program
    {
        static void Main(string[] args) { 
            ...
            string declarationaAndInitialization = "This is both declaring and initializing";
            ...
            // Composite
            string compositFullName = string.Format("{0} " +
                "d{1}", firstName, lastName);
            // interpolation
